/**
 * Разбивает доску на фрагменты и преобразует фрагменты в вектор
 * Фрагменты определяются квадратами со сторонами от 3х до 8
 * 8 означает, что фрагмент представляет собой всю доску
 * Фрагменты накладываются друг на друга, перекрывая себя, перемещаются на одно поле
 */
class InputEncoder {
