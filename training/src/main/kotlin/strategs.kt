...
fun teachNet(layersCapacity: List<Int>, populationSize: Int,
    ...
    with(EvolutionCheckers(populationSize, layersCapacity, 10, 50, 2, mutantRate, dir, savePerEpoch)) {
...
fun main(args: Array<String>) {
    ...
    while (true) {
        println("~~~ test 1 ~~~~")
        val nw1 = teachNet(listOf(60, 20, 10), 20, 1, 0.02, "testnets/test1/")
        println("~~~ test 2 ~~~~")
        val nw2 = teachNet(listOf(40, 20, 5), 20, 1, 0.02, "testnets/test2/")
